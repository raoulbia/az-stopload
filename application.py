        ...
        [
            dash_table.DataTable(
                ...
                style_cell_conditional = [
                                            {'if': {'column_id': ['Direction', 'RoutesCount', 'PlateCode', 'isRTPI']},
                                             'width': '100px'},
                                            {'if': {'column_id': 'OperatorsCount'},
                                             'width': '110px'},
                                            {'if': {'column_id': 'OperatorsPassingThrough'},
                                             'width': '190px'},
                                            {'if': {'column_id': ['RoutesPassingThrough',
                                                                  'StopAccessibility',
                                                                  'WheelchairAccessibility']},
                                             'width': '180px'}]
            )
